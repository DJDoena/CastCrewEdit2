...
internal partial class EpisodesForm : CastCrewEdit2BaseForm
{
    ...
    private void ScanRows(IEnumerable rows)
    {
        ...
        try
        {
            foreach (DataGridViewRow row in rows)
            {
                ...
                episode.CastMatches = new List<CastMatch>();
                episode.CrewMatches = new List<KeyValuePair<CreditTypeMatch, List<CrewMatch>>>();
    ...
    internal void ParseIMDb(EpisodeInfo episode)
    {
